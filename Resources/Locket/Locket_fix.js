...
var quanghuwngg_entitlement = {
  grace_period_expires_date: null,
  purchase_date: specificDate, // Ngày tham gia
  product_identifier: "com.quanghuwngg.premium.yearly",
  expires_date: "2099-12-18T01:04:17Z" // Ngày hết hạn lâu dài
};
...
if (match) {
  ...
  let subscriptionKey = mapping[match][1] || "com.quanghuwngg.premium.yearly";

  obj.subscriber.subscriptions[subscriptionKey] = quanghuwngg;
  obj.subscriber.entitlements[entitlementKey] = quanghuwngg_entitlement;
} else {
  // Gán mặc định nếu không có khớp
  obj.subscriber.subscriptions["com.quanghuwngg.premium.yearly"] = quanghuwngg;
  obj.subscriber.entitlements["Locket"] = quanghuwngg_entitlement;
}

// ========= Thêm thông báo và Log ========= //
obj.Attention = "Gói Locket Gold được tạo bởi Nguyễn Quang Hưng";
